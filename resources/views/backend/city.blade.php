      ...
      <div class="container-fluid">
       ...
       <div class="card mb-4">
            <div class="card-header">
                ...
                <span class="error-name">New City</span>
                <span class="successmsg"></span>
            </div>
            <div class="card-body">
                <form class="row gx-3 gy-2 align-items-center" id="city-newform">
            ...
            <div class="col">
              <div class="card shadow">
                ...
                <div class="table-responsive  p-1">
                  <table class="table align-items-center table-flush" id="city-table">
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('#city-newform').submit(function(e){
      e.preventDefault();
