                ...
                <div class="row">
                    ...
                    <div class="col-md-4 ftco-animate fadeInUp ftco-animated">
                        <div class="project-wrap">
                            <a href="#" class="img" style="background-image:url({{url('frontnew/assets/img/file/myanmar.jpeg')}})">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                <li><i class="fas fa-bath fa_bath_icon"></i>2</li>
                                <li><i class="fas fa-bed fa_bed_icon"></i>3</li>
        ...
        <div class="container my-5">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-sm-9 col-md-4 mb-3 mb-md-0 h-100">
              <div class="card card-span text-white h-100"><img class="img-card h-100" src="{{asset('frontnew/assets/img/file/myanmar.jpeg')}}" alt="..." />
                <div class="card-body px-xl-5 px-md-3 pt-0 pb-7">
                  <div class="d-flex justify-content-between align-items-center bg-100 mt-n5 me-auto"><img src="{{asset('frontnew/assets/img/file/myanmar.jpeg')}}" width="60" alt="..." />
