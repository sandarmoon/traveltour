...
<html lang="en-US" dir="ltr">
    <head>
        ...
        <!-- ===============================================-->
        <link
            href="{{ asset('frontnew/assets/css/theme.css') }}"
            rel="stylesheet"
        />
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('frontnew/assets/css/mystyle.css') }}"
        />
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-6 col-8 col-lg-6 card shadow">
                                <div class="py-8">
                                    <span class="fw-bold fs-4 text-primary ms-2"
                                        >Contact Form</span
                                    >
                            ...
                            <div
                                class="
                                    ...
                                    bg-primary-gradient bg-offcanvas-right
                                "
                            >
                                <div class="py-7">
                                    <img
                                        ...
                                        src="{{
                                            asset('frontend/assets/travel.svg')
                                        }}"
                                        width="40"
                                        alt="logo"
                                    /><span class="fw-bold fs-4 text-light ms-2"
                                        >Advance Agency</span
                                    >
                                    ...
                                    <div class="py-7 p-md-7">
                                        ...
                                        <p class="text-light">
                                            ...
                                            ><span class="text-light lh-lg"
                                                >333, Lorem Street, Albania,
                                                Alifornia<br />United States of
                                                America</span
                                            >
                                        </p>
                                        <div class="mt-6">
                                            <a href="#!">
                                                <img
                                                    ...
                                                    src="{{
                                                        asset(
                                                            'frontnew/assets/img/icons/facebook.svg'
                                                        )
                                                    }}"
                                                    alt="..."
                                            /></a>
                                            ...
                                            <a href="#!">
                                                <img
                                                    ...
                                                    src="{{
                                                        asset(
                                                            'frontnew/assets/img/icons/twitter.svg'
                                                        )
                                                    }}"
                                                    alt="..."
                                            /></a>
                                            ...
                                            <a href="#!">
                                                <img
                                                    ...
                                                    src="{{
                                                        asset(
                                                            'frontnew/assets/img/icons/instagram.svg'
                                                        )
                                                    }}"
                                                    alt="..."
                                            /></a>
